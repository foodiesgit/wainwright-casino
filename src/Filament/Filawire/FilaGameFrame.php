...
class FilaGameFrame extends Component
{
    ...
    public function render(Request $request)
    {
    	...
    	if($request->slug === NULL) {
            ...
            return view('wainwright::filament.filawire.random-games-polling')->with(['games' => $this->games, 'viewType' => 'no-game-selected', 'text' => 'You first need to a select a game to start playing.']);
            } else {
                return view('wainwright::filament.filawire.launcher')->with(['games', $this->games, 'viewType' => 'gamelaunch', 'slug' => 'none', 'game_name' => 'none.com', 'url' => 'none.com', 'text' => 'Goodluck!']);
